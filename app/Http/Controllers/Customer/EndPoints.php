...
class EndPoints
{
    ...
    public const SHOP_SEARCH = '/api/customer/search';
    ...
    public const ADD_TO_FAVORITE_SHOP = '/api/customer/products/add_to_favourite';
    public const ADD_TO_CART = '/api/customer/cart/add_to_cart';
    public const CART = '/api/customer/cart';
    //Customer
