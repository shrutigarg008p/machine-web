    ...
    
    {
        $user = $this->user();
         ...
         $request->validate([
            ...
            'email' => ['required', 'email', 'max:191', 'unique:user_addresses,email,'.$user->id.',user_id'],
            'phone' => ['required', 'digits_between:8,12', 'unique:user_addresses,phone,'.$user->id.',user_id'],
