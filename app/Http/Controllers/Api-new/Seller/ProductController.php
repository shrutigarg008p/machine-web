...
class ProductController extends ApiController
{
            ...
            $products->with([
                'seller_product' => function($query) use($user,$selected_shop) {
                    $query->where('seller_products.seller_id', $user->id)
                        ->where('seller_products.shop_id', $selected_shop->id);
                }
            ]);
        }
    ...
    public function destroy(Request $request)
    {
        ...
        return $sellerProduct = $seller->seller_products()
    ...
    public function softdelete(Request $request){
       ...
       $sellerProduct = $seller->seller_products()->where('product_id',$validated['product_id'])->where('shop_id',$validated['shop_id']);
       $sellerProduct->delete();
       return ApiResponse::ok(__('Product removed'));
   }
}
