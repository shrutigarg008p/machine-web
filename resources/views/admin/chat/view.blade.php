                ...
                <div class="card-body">
                    <div class="panel panel-default">
                        ...
                        <div class="mt-4 chats-body panel-body d-flex flex-column-reverse" style="padding:1rem;">
                            <ul class="chats">
                                @foreach ($messages as $message)
                                    <li class="chat clearfix d-flex justify-content-{{ $message->user_id === $user->id ? 'end':'start' }}">
                        ...
                        <div class="panel-footer mt-4">
                            <form id="chat-submit" class="d-flex align-items-center" action="{{ route('admin.chat.channel.messages.send', ['channel' => $channel->id]) }}" method="post">
                                @csrf
                                <input id="chat-submit-input" type="text" name="message" class="form-control input-sm" placeholder="Type your message here..." autocomplete="off">
