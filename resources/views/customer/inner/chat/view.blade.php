            ...
            <div class="col-md-9">
                <div class="card" id="myTab">
                    ...
                    <div class="chat-wraper">
                        ...
                        <div class="chat_heading">Chat</div>
                        <div class="chat_wrapper">
                            <div class="chat_user_img">
                                <img src="http://localhost/machine-web/seller/images/profie-icon.png" alt="" class="img-fluid">
                            </div>
                            <div class="virtual-chat order-chat">
                                <div class="content">
                                    <p class="">
                                        <span class="english">{{ ucwords($participants->implode('name', ',')) }} </span>
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="virtual-chat {{ $message->user_id === $user->id ? 'even' : '' }}" style="max-width: inherit">
                                <div class="content">
                                    <p class="chat {{ $message->user_id === $user->id ? 'even' : '' }}">
                                        ...
                                        @endif
                                        <span class="english chat_date"><i>
