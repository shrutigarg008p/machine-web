                                    ...
                                    <tr>
                                       <td>
                                          <div class="dataDiv" style="color:#666666;font-family:Lucida Grande,Lucida Sans,Lucida Sans Unicode,Arial,Helvetica,Verdana,sans-serif;font-size:12.5px;line-height:1.75em;padding:0 60px;">
                                             ...
                                             <br>
                                             <br>
                                             <p>{{__('We are excited to have you join our team. To complete your registration and confirm your account, you need to enter otp.')}}</p>
                                             <br>
                                             <div style="width:100%;text-align:center;"><p>{{ $user['otp']}}</p>
                                             </div>
                                             <br>
                                             {{--  
                                             <p>{{__('If that does not work for some reason, copy, and paste the following link below in your browser.')}} </p>
                                             <a href="{{url('admin/user/verify/'.$user->verifyuser->token)}}">link</a><br> --}}
                                             {{__('Cheers')}}<br>
