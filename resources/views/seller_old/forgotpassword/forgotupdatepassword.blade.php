...
<html lang="en">
   <head>
      ...
      <title>{{__('Machine Enquiry')}}</title>
      <!-- Font Awesome Icons -->
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
      ...
      <body>
         ...
         <div class="row mt">
            <div class="col-md-12">
               <h2 style="margin: 0px 0px 12px 12px;">{{__('Forgot Password')}}</h2>
            </div>
         </div>
         <div>
         ...
         <div class="row">
            ...
            <div class="col-lg-12">
               <div class="form-panel" style="margin:10px;">
                  <form method="post" id="passwordvalidation" action="{{url('seller/forgotpasswordupdate')}}" data-parsley-validate >
                     {{csrf_field()}}
                     <div>
                        @if($message=Session::get('success'))
                        <div class="alert alert-success">
